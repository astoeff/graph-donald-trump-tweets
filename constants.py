...
LAST_TWEET_YEAR = TWEETS_YEARS[-1]
COLLECTION_NAMES = ['tweets_' + i for i in TWEETS_YEARS]
LAST_COLLECTION_NAME = COLLECTION_NAMES[-1]
...
TEXT_FIELD = 'text'
SELECT_BY_REGEX = '$regex'
MONDAY_IN_DATE = '^Mon'
TUESDAY_IN_DATE = '^Tue'
WEDNESDAY_IN_DATE = '^Wed'
THURSDAY_IN_DATE = '^Thu'
FRIDAY_IN_DATE = '^Fri'
SATURDAY_IN_DATE = '^Sat'
SUNDAY_IN_DATE = '^Sun'
LIST_OF_DAYS_IN_DATE = [MONDAY_IN_DATE, TUESDAY_IN_DATE, WEDNESDAY_IN_DATE,
                        THURSDAY_IN_DATE, FRIDAY_IN_DATE, SATURDAY_IN_DATE, SUNDAY_IN_DATE]
DATABASE_NEEDS_SETUP_WARNING = 'Please first setup the database!'
